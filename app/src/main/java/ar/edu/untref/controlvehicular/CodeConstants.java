...
public final class CodeConstants {
    ...
    public static final byte BLOQUEAR_PUERTAS = (byte) 0b00001010;
    public static final byte DESBLOQUEAR_PUERTAS= (byte) 0b00001011;
    public static final byte BOCINA	= (byte) 0b00001100;
